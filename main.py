...
def top_headlines():
	newsapi = NewsApiClient(api_key = "82b77c8c58794052be5fbc25a885f2e9")
	...
	sorted_top_words = sorted([{'word':k, 'size': v * 7} for k,v in top_words_dict.items()], key = lambda x: x['size'], reverse = True)[:30]
